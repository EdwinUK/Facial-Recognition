...
class SpoofDetection:
    ...
    def __init__(self):
        self.efficientnet_model = tf.keras.models.load_model("efficientnetb0.h5")

    def spoof_detector(self):
        # Preprocessing the input image then passing the input to the model to make a prediction
        input_image = efficientnet_preprocess(os.path.join("application_data", "input_image", "input_image.jpg"))
